      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="dark w-[--sidebar-width] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden border-r border-sidebar-border shadow-2xl"
            style={
              {
          ...
          >
            <SheetHeader className="sr-only">
              ...
              <SheetDescription>
                Dashboard navigation links for mobile users.
              </SheetDescription>
            </SheetHeader>
