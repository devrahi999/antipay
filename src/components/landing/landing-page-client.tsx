        ...
        <section id="features" className="py-24 bg-background relative">
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                { icon: Zap, title: "Instant Verification", desc: "Our engine processes transaction data in milliseconds, providing instant verification results to your application." },
                { icon: Cpu, title: "API-First Infrastructure", desc: "A robust and scalable infrastructure designed to handle high-volume transaction verification with zero latency." },
                { icon: Code2, title: "Developer First API", desc: "Clean JSON APIs and SDKs designed to be integrated in less than 30 minutes for any modern tech stack." },
                { icon: BarChart3, title: "Real-time Analytics", desc: "Monitor your transaction volume, success rates, and customer behavior with our intuitive analytics dashboard." },
                { icon: Lock, title: "Enterprise Security", desc: "Bank-grade encryption for all API calls and sensitive data storage. Your transaction privacy is our priority." },
                { icon: MessageCircle, title: "Dedicated Support", desc: "Access our expert support team via WhatsApp or Email whenever you need assistance with your integration." }
              ].map((feature, idx) => (
        ...
        <section id="faq" className="py-24 bg-background">
          <div className="container mx-auto px-4 md:px-6 max-w-3xl">
            ...
            <Accordion type="single" collapsible className="w-full space-y-4">
              {[
                { q: "How secure is the verification process?", a: "Extremely secure. We use bank-grade encryption and only monitor verified banking signals. All data is encrypted with TLS 1.3 before being processed." },
                { q: "Which payment methods are supported?", a: "We currently support bKash, Nagad, Rocket, Upay, CellFin, and Tap. We are constantly adding new local providers based on merchant requests." },
                { q: "Do I need a formal merchant account?", a: "No! AntiPay works with both Personal and Merchant accounts. Our system is designed to handle verification regardless of your account tier." },
                { q: "Can I use AntiPay for high-volume transactions?", a: "Yes. Our infrastructure is built on Google Cloud and auto-scales to handle thousands of concurrent verification requests effortlessly." }
              ].map((faq, i) => (
